...
namespace Wongoo_Application.Views
{
    ...
    public partial class EditProduct : TabbedPage
    {
        public EditProduct(string barcode)
        {
            InitializeComponent();
            BindingContext = new EditProductViewModel(barcode);
        }

        private void GoToInredients_Clicked(object sender, EventArgs e)
        {
